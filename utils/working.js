    ...
    s3.upload(params, async function (err, data) {
      ...
      const command = ffmpeg()
        ...
        .on("error", function (err, stdout, stderr) {
          console.log(`***Error 1: ${fileName}: Error while running FFmpeg command:\n${command.toString()}\n`);
          console.log(`Error 2: FFmpeg stdout:\n${stdout}\n`);
          console.log(`Error 3: FFmpeg stderr:\n${stderr}\n`);
          console.log(`Error 4: FFmpeg error message: ${err.message}\n`);
        })
